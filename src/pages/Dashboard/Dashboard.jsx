          ...
          <div className="content-header">
            <div>
              ...
              <p className="page-subtitle">
                {getRoleIcon()} {getRoleLabel()} • {new Date().toLocaleDateString('fr-FR', { 
                  weekday: 'long', 
                  day: 'numeric', 
                  month: 'long' 
                })}
              ...
              {user.role === 'etudiant' && (
                <>
                  <div className="action-card" onClick={() => navigate('/courses')}>
                    ...
                    <h3>Mes cours</h3>
                    <p>Accéder à tous vos cours et ressources</p>
                  ...
                  <div className="action-card" onClick={() => navigate('/downloads')}>
                    ...
                    <p>Documents et ressources pédagogiques</p>
                    <div className="card-footer">
                  ...
                  <div className="action-card" onClick={() => navigate('/chat')}>
                    <div className="card-icon" style={{ background: '#fef7e0' }}>
                      <MessageCircle size={24} color="#b45309" />
                    </div>
                    <h3>Chat IA</h3>
                    <p>Posez vos questions sur les cours</p>
                    <div className="card-footer">
              ...
              {user.role === 'enseignant' && (
                <>
                  <div className="action-card" onClick={() => navigate('/upload')}>
                    ...
                    <p>Ajouter un nouveau cours pour vos étudiants</p>
                    <div className="card-footer">
                      <span>Nouveau</span>
                      <ChevronRight size={16} />
                    </div>
              ...
              {user.role === 'admin' && (
                <>
                  <div className="action-card" onClick={() => navigate('/admin/users')}>
                    ...
                    <h3>Utilisateurs</h3>
                    <p>Gérer les comptes étudiants et enseignants</p>
                    <div className="card-footer">
                  ...
                  <div className="action-card" onClick={() => navigate('/admin/stats')}>
                    ...
                    <h3>Statistiques</h3>
                    <p>Analyser les données de la plateforme</p>
                    <div className="card-footer">
                      <span>Rapports</span>
                      <ChevronRight size={16} />
                    </div>
              ...
              <div className="schedule-list">
                <div className="schedule-item">
                  ...
                  <div className="schedule-info">
                    <span className="schedule-course">Développement Web</span>
                ...
                <div className="schedule-item">
                  ...
                  <div className="schedule-info">
                    <span className="schedule-course">Base de données</span>
                ...
                <div className="schedule-item">
                  ...
                  <div className="schedule-info">
                    <span className="schedule-course">Réseaux</span>
            ...
            <div className="grid-card">
              ...
              <div className="activity-list">
                ...
                <div className="activity-item">
                  ...
                  <div className="activity-content">
                    <p className="activity-text">Devoir à rendre: Projet React</p>
                ...
                <div className="activity-item">
                  ...
                  <div className="activity-content">
                    <p className="activity-text">Note publiée: Algorithmique</p>
              ...
              <div className="events-list">
                <div className="event-item">
                  ...
                  <div className="event-info">
                    ...
                    <span className="event-desc">Dernier délai: 23:59</span>
                  </div>
                </div>
                <div className="event-item">
                  <div className="event-date">
                  ...
                  <div className="event-info">
                    <span className="event-title">Examen Base de données</span>
                ...
                <div className="event-item">
                  ...
                  <div className="event-info">
                    <span className="event-title">TP Réseaux</span>
            ...
            <div className="grid-card">
              ...
              <div className="favorites-list">
                <div className="favorite-item">
                  ...
                  <span className="favorite-name">Développement Web Avancé</span>
                  <span className="favorite-progress">75%</span>
                </div>
                <div className="favorite-item">
                  <Bookmark size={16} color="#137333" />
                  <span className="favorite-name">Architecture des Réseaux</span>
